package {
    ...
    public class Player extends Entity {
        ...
        [Embed(source='assets/hero_left_48x53.png')]
        private const PLAYER_LEFT:Class;
        [Embed(source='assets/hero_up_48x53.png')]
        private const PLAYER_UP:Class;
        [Embed(source='assets/hero_down_48x53.png')]
        private const PLAYER_DOWN:Class;
        [Embed(source='assets/hero_right_48x53.png')]
        private const PLAYER_RIGHT:Class;

        [Embed(source='assets/hero_glasses_spritemap.png')]
        private const PLAYER_WIN:Class;
        ...
        private function handleWeapons():void {
            ...
            if (bulletWait <= 0 && bullets > 0 && Input.pressed(Key.SPACE)) {
                var bullet:Bullet = FP.world.create(Bullet, false) as Bullet;
                bullet.reset();
